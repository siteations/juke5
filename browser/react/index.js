...
import {FilterableArtistsContainer, FilterContainerContainer} from './containers/FilterableArtistsContainer';
import NewPlaylistContainer from './containers/NewPlaylistContainer';
import PlaylistContainer from './containers/PlaylistContainer';
import {LyricsContainer, LyricsContainerContainer} from './containers/LyricsContainer';
// import LyricsContainerContainer from './containers/LyricsContainerContainer';
  ...
  <Provider store={store}>
    <Router history={hashHistory}>
      <Route path="/" component={App} onEnter={onAppEnter}>
        ...
        <Route path="/artists" component={FilterContainerContainer}/>
        ...
        <Route path="/lyrics" component={LyricsContainerContainer} />
